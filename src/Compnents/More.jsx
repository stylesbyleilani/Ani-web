...
// const More = () => {
//   return (
//     <div className="div flex flex-col md:flex-row items-center gap-10 justify-center">

// <div className="div-1 relative items-center w-[300px] h-[500px] md:w-[400px] md:h-[500px] rounded-md p-2 bg-neutral-800">
...
//   </div>
//   <div className=" h-[477px] rounded-md border-[1px] border-gray-600 border-b-[1px] border-b-green-700 ">
...
const More = () => {
  ...
  return (
    <motion.div
      className="div flex flex-col md:flex-row items-center gap-10 justify-center"
