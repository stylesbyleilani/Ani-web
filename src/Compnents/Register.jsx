...
//   </form>
//   <p className='link mt-3'>Dont't have an account? <Link to="/login"><span className='text-my-100'>Login</span></Link> </p>
    ...
    <div className='text-center flex-col items-center justify-center mt-24 md:mt-12 text-gray-200'>
      ...
      <form className='flex mt-10 flex-col items-center justify-center gap-5' onSubmit={handleSubmit}>
        ...
        <div className="remember">
          ...
          <Link to="/"><button className='border-gray-300 text-my-200 bg-my-100 w-[300px] rounded-md md:w-[400px] p-2 md:p-4' type='submit'>
          Register
        </button> 
        </Link>
      </form>
