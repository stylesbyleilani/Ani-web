...
//         </div>
//         <h1 className='text-3xl text-gray-100 md:text-5xl'>Supported <span className='bg-gradient-to-r from-my-400 via-my-500 to-my-100 text-transparent bg-clip-text'>AMMS</span></h1>
//         <p className="mt-2 p-7 md:p-5 text-base sm:text-lg lg:text-xl text-center text-gray-200 max-w-2xl lg:max-w-4xl">
//           We facilitate non-custodal,automated and active management of concentrated liquidity across various platforms.
//         </p>
//          </div>
...
//          <div className="div flex  gap-7 md:gap-7 lg:gap-10 flex-col md:flex-row lg:flex-row   items-center mt-5 justify-center" >


// <div className="div-1 relative items-center w-[300px] h-[200px] md:w-[400px] md:h-[200px] rounded-md p-2 bg-neutral-800">
...
//   <div className="div flex items-start flex-col text-gray-50 border-[1px] border-gray-600 rounded-md w-[280px] md:w-[380px] h-[170px] p-5 border-b-[1px] border-b-green-700 ">
// <div className="div border-[1px] border-green-500 rounded-full flex justify-center items-center w-7 h-7  ">
//   <FaGgCircle className='text-white'/>
// </div>
// <div className="div flex items-start flex-col ">
...
//   {/* <div className="div-1 relative items-center w-[300px] mt-10 h-[200px] md:w-[400px] md:h-[200px] rounded-md p-2 bg-green-500">
//   </div> */}
...
const Service = () => {
  ...
  return (
    <div className='text-center'>
      ...
      <div className="flex gap-7 md:gap-7 lg:gap-10 flex-col md:flex-row lg:flex-row items-center mt-5 justify-center">
        {/* Card 1 */}
        <motion.div
          className="relative items-center w-[300px] h-[200px] md:w-[400px] md:h-[200px] rounded-md p-2 bg-neutral-800"
          initial="hidden"
          animate={controls}
          variants={fadeInVariants}
        >
